...
export const resicoCalculator: CalculatorConfig = {
  ...
  content: {
    ...
    howToInterpret: 'El cálculo desglosa tu obligación mensual de ISR en RESICO:\n1. Tasa Efectiva Directa: Varía del 1.00% al 2.50% según el tramo de ingresos cobrados en el mes. No permite restar gastos operativos para ISR.\n2. Retención del 1.25% de Personas Morales: Si facturas a empresas, el comprobante de retención te permite descontar el 1.25% de tu pago mensual.\n3. ISR Neto a Pagar: Es el monto final que debes pagar en el portal del SAT mediante línea de captura bancaria antes del día 17 del mes posterior.',
  ...
  translations: {
    en: {
      ...
      content: {
        ...
        howToInterpret: 'The simulation provides a breakdown of your monthly RESICO tax liability:\n1. Direct Statutory Rate: Varies between 1.00% and 2.50% based strictly on cash-basis income collected during the month. Operating deductions are not allowed for income tax.\n2. 1.25% Corporate Withholding: When billing corporate entities (Personas Morales), their 1.25% withholding credit directly offsets your tax bill.\n3. Net ISR Payable: The net amount owed to the SAT via banking capture line (línea de captura) on or before the 17th of the following month.',
