...
export const finiquitoCalculator: CalculatorConfig = {
  ...
  content: {
    ...
    howToInterpret: 'El desglose del resultado presenta dos bloques claramente diferenciados:\n1. Subtotal Finiquito (Prestaciones Devengadas): Son importes que ya trabajaste y ganaste por ley (días pendientes, proporción de aguinaldo, vacaciones y prima vacacional). Este bloque te corresponde íntegro en cualquier baja, incluso si renuncias voluntariamente.\n2. Subtotal Liquidación (Indemnizaciones por Despido): Comprende los 90 días constitucionales, los 20 días por año y la prima de antigüedad. Solo te corresponde si el patrón rescinde la relación de trabajo sin causal justificada de las previstas en la LFT.\n3. Exención fiscal: Las prestaciones ordinarias causan ISR según tarifa mensual, mientras que las indemnizaciones gozan de una exención legal de hasta 90 UMAs por cada año de antigüedad conforme al Art. 93 Fracción XIII de la LISR.',
  ...
  translations: {
    en: {
      ...
      content: {
        ...
        howToInterpret: 'The calculation results are divided into two distinct statutory blocks:\n1. Finiquito Subtotal (Accrued Entitlements): Amounts you have already earned through service (unpaid salary, prorated Christmas bonus, unused vacation and vacation bonus). This portion is payable in 100% of separations, including voluntary resignation.\n2. Liquidación Subtotal (Dismissal Indemnity): Comprises 90 days constitutional indemnity, 20 days per year worked, and seniority premium. Payable exclusively if dismissed without legal cause under Article 47 LFT.\n3. Tax Exemption: Ordinary accrued benefits are subject to standard monthly ISR, while dismissal indemnities enjoy a statutory exemption of up to 90 UMAs per completed year of service under Article 93 Section XIII LISR.',
